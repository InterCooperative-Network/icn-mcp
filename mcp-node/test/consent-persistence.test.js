...
import { persistConsentDecision, checkPersistedConsent, resetDbInstance, deleteAllConsentsForUser } from '../src/consent/persistence.js';
...
describe('Consent Persistence and Enforcement', () => {
    ...
    describe('ConsentManager Database Integration', () => {
        it('should persist consent decisions to database', () => {
            ...
            const persistedDecision = manager.persistConsent(userId, toolName, resource, response, 'high');
    ...
    describe('Consent Expiration', () => {
        ...
        it('should clean up expired consents', () => {
            ...
            persistConsentDecision(userId, 'icn_write_patch', undefined, true, 'Expired consent', 'high', pastTimestamp // Already expired
            );
            // Add current consent
            persistConsentDecision(userId, 'icn_run_tests', undefined, true, 'Valid consent', 'medium');
    ...
    describe('Direct Persistence Functions', () => {
        it('should persist and retrieve consent decisions', () => {
            ...
            const resource = 'src/test.ts';
            // Persist decision
            const decision = persistConsentDecision(userId, toolName, resource, true, 'Direct persistence test', 'high');

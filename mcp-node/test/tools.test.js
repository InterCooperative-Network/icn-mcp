...
import { icnStartWorkflow, icnGetNextStep, icnCheckpoint, icnListWorkflowTemplates, icnGetWorkflowState } from '../src/tools/icn_workflow.js';
describe('ICN Tools', () => {
    ...
    describe('icnGetTaskContext', () => {
        ...
        it('should include task-specific acceptance tests based on invariants', async () => {
            ...
            expect(result.acceptance_tests.some(test => test.includes('code compiles and tests pass'))).toBe(true);
            expect(result.acceptance_tests.some(test => test.includes('policy allow'))).toBe(true);
        });
    ...
    describe('icnSuggestApproach', () => {
        ...
        it('should include MCP-specific suggestions for MCP tasks', async () => {
            ...
            const hasMcpApproach = result.suggested_approaches.some(approach => approach.approach_name.toLowerCase().includes('mcp'));
    ...
    describe('Specification Synthesis and Validation Framework', () => {
        ...
        describe('icnGenerateTests', () => {
            ...
            it('should generate tests for Event Log component', async () => {
                ...
                expect(testSuite.testCases.some(t => t.name.includes('append') || t.name.includes('event'))).toBe(true);
